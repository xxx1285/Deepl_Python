...
class ForbesUrlSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.forbes.com.au/']
    custom_settings = {
    ...
    exclude_words = ['wiki', 'google', 'forbes', '.gov', '.edu', 'livejournal', 'blogspot', 'wordpress', 'broadwayworld', 
                     'facebook', 'yandex', 'youtube', 'twitter', 'linkedin',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Wikipedia\\JSON_Wiki_result\\forbes\\urls-FORBES_com_au-v1.json'
