...
class ForbesUrlSpider(scrapy.Spider):
    name = 'gazeta'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['gazeta.ua']
    start_urls = ['https://gazeta.ua/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Wikipedia\\JSON_Wiki_result\\gazeta_ua\\urls-gazeta.ua-v1.json'
