...
class ForbesUrlSpider(scrapy.Spider):
    name = 'lemonde.fr_urls_india'
    allowed_urls = ['lemonde.fr']
    ...
    exclude_words = ['wiki', 'google', 'forbes', '.gov', '.edu', 'livejournal', 'blogspot', 'wordpress', 'broadwayworld', 
                     'facebook', 'yandex', 'youtube', 'twitter', 'linkedin', 'lemonde', 
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Wikipedia\\JSON_Wiki_result\\lemonde_fr\\urls-lemonde_fr-v1.json'
