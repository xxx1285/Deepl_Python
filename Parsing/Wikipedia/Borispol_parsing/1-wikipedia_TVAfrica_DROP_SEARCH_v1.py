...
class ForbesUrlSpider(scrapy.Spider):
    name = 'https://en.wikipedia.org/wiki/TVAfrica'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['wikipedia.org']
    start_urls = ['https://en.wikipedia.org/wiki/TVAfrica']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-wikipedia_org_TVAfrica-v1.json'
