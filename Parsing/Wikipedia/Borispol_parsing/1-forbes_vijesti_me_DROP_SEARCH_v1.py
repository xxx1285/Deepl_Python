...
class ForbesUrlSpider(scrapy.Spider):
    name = 'forbes-vijesti-me'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    ...
    start_urls = ['https://forbes.vijesti.me/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-forbes_vijesti_me-v1.json'
