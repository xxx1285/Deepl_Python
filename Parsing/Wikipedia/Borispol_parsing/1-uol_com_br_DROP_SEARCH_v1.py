...
class ForbesUrlSpider(scrapy.Spider):
    name = 'uol.com.br'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['uol.com.br']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-uol.com.br-v1.json'
