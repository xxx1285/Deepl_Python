...
class ForbesUrlSpider(scrapy.Spider):
    name = 'almomento.net'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['almomento.net']
    start_urls = ['https://almomento.net/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-almomento.net-v1.json'
