...
class ForbesUrlSpider(scrapy.Spider):
    name = 'https://www.theguardian.com/europe'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['theguardian.com']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-theguardian.com-v1.json'
