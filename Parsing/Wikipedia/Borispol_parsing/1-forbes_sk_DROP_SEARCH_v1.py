...
class ForbesUrlSpider(scrapy.Spider):
    name = 'forbes.sk'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    ...
    start_urls = ['https://www.forbes.sk/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-forbes_sk-v1.json'
