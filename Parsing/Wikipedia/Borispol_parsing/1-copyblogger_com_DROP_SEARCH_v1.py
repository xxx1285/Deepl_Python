...
class ForbesUrlSpider(scrapy.Spider):
    name = 'copyblogger.com'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['copyblogger.com']
    start_urls = ['https://copyblogger.com/stop-self-editin/']
    custom_settings = {
    ...
    exclude_words = ['wiki', 'google', 'forbes', '.gov', '.edu', 'livejournal', 'blogspot', 'wordpress', 'broadwayworld', 
                     'facebook', 'yandex', 'youtube', 'twitter', 'linkedin', 'lemonde', 'shopping', '.html',
                     '.ru', '.by', '.kz', '.fr', '.it', '.uz', '.jp', '.eu', 
                     '.de', '.az', '.us', '.ca', '.no'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-copyblogger.com-v1.json'
