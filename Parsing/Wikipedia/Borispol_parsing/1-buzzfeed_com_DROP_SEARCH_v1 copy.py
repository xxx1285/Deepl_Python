...
class ForbesUrlSpider(scrapy.Spider):
    name = 'https://www.buzzfeed.com/'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['buzzfeed.com']
    start_urls = ['https://www.buzzfeed.com/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Parsing\\JSON_Wiki_result\\urls-buzzfeed.com-v1.json'
