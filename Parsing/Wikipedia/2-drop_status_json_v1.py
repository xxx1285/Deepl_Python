...
json_file = r'D:\Gembling\Deepl_Python\Deepl_Python\Parsing\Wikipedia\JSON_Wiki_result\forbes\urls-FORBES_com_au-v1.json'  # Путь к исходному JSON-файлу
output_json = r'D:\Gembling\Deepl_Python\Deepl_Python\Parsing\Wikipedia\JSON_Wiki_result\forbes\urls-FORBES_com_au-v1-RES.json'  # Путь для нового JSON-файла
