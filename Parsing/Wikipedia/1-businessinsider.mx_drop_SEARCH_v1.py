...
key_name = 'businessinsider'

class ForbesUrlSpider(scrapy.Spider):
    name = 'businessinsider'   # ключ для пошуку внутрішніх сторінок по яким ходить паук
    allowed_urls = ['businessinsider.mx']
    ...
    start_urls = ['https://businessinsider.mx/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Wikipedia\\JSON_Wiki_result\\businessinsider\\urls-businessinsider.mx-v1.json'
