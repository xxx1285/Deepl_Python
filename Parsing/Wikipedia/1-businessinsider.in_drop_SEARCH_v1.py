...
class ForbesUrlSpider(scrapy.Spider):
    ...
    allowed_urls = ['businessinsider.in']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Wikipedia\\JSON_Wiki_result\\businessinsider\\urls-businessinsider.in-v1.json'
