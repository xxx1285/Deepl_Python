...
# Открываем CSV файл
csv_file_path = r'Parsing\Pragmatic-play\3_Zaliv_PragmatGames_on_SQLsite\input\output-urls-games-14-02-2024.csv'
    ...
    with connect_database.cursor() as cursor:
        with open(csv_file_path, mode='r', newline='', encoding='utf-8') as file:
            ...
            for row in csv_reader:
                ...
                description     = row['title_game'] + " 1win slot game &#127875; for free play with Pragmatic play. Spin the reels " + row['title_game'] +" and experience this epic game"
                alias           = row['alias']
                menuindex       = 0
                template        = 29
                res_context_key = "web"
