...
class ForbesUrlSpider(scrapy.Spider):
    name = 'mittechreview'
    allowed_urls = ['mittechreview.com.br']
    start_urls = ['https://mittechreview.com.br/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Poisk-Dropov\\Brazil\\Result_JSON\\2-urls-mittechreview.com.br-v1.json'
