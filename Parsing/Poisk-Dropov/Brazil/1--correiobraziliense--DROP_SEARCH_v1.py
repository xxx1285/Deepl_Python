...
class ForbesUrlSpider(scrapy.Spider):
    ...
    allowed_urls = ['correiobraziliense.com.br']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Poisk-Dropov\\Brazil\\Result_JSON\\urls-correiobraziliense.com.br-v1.json'
