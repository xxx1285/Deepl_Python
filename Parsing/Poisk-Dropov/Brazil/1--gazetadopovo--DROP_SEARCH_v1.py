...
class ForbesUrlSpider(scrapy.Spider):
    name = 'gazetadopovo'
    allowed_urls = ['gazetadopovo.com.br']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Poisk-Dropov\\Brazil\\Result_JSON\\urls-gazetadopovo.com.br-v1.json'
