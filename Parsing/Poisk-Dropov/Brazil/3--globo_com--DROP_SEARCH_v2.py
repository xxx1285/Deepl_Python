...
class ForbesUrlSpider(scrapy.Spider):
    ...
    start_urls = ['https://gshow.globo.com/']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Poisk-Dropov\\Brazil\\Result_JSON\\3-urls-gshow-globo.com-v1.json'
