...
class ForbesUrlSpider(scrapy.Spider):
    ...
    start_urls = ['https://en.wikipedia.org/wiki/List_of_newspapers_in_Brazil']
    custom_settings = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Poisk-Dropov\\Brazil\\Result_JSON\\2-urls-wikipedia_org-v1.json'
