...
class ForbesUrlSpider(scrapy.Spider):
    name = 'brasildefato'
    allowed_urls = ['brasildefato.com.br']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_path = 'D:\\Gembling\\Deepl_Python\\Deepl_Python\\Parsing\\Poisk-Dropov\\Brazil\\Result_JSON\\3-urls-brasildefato-v2.json'
