...
async def main(json_file, output_json):
    ...
    async with aiohttp.ClientSession(connector=connector, headers=headers) as session:
        semaphore = asyncio.Semaphore(40)  # Ограничение количества одновременных задач
        tasks = []
...
json_file = r'D:\Gembling\Deepl_Python\Deepl_Python\Parsing\Poisk-Dropov\Brazil\Result_JSON\del2\2-urls-brasildefato-v2.json'  # Путь к исходному JSON-файлу
output_json = r'D:\Gembling\Deepl_Python\Deepl_Python\Parsing\Poisk-Dropov\Brazil\Result_JSON\del2\2-urls-brasildefato-v2-RES.json'  # Путь для нового JSON-файла
