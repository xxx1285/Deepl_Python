...
input_file = r'GOOGLE\Google_maps_Adress_API\input\input_borispol_adress.txt'
output_file_txt = r'GOOGLE\Google_maps_Adress_API\output\output_adress_Start_NOEND_Point_v2.txt'
