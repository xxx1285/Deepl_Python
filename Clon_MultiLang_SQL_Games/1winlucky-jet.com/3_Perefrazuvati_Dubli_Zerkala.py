...
# BABEL JSON path
babel_file_path = f'Clon_MultiLang_SQL_Games\\{current_folder}\\Babel_svyazi_all_lang\\babel_baza_dict_PL.json'
# SQL Config path
...
MY_SITE = "https://1winlucky-jet.com/"
site_name = "Lucky Jet"
author_name = "Steve Bourie"
...
context_and_lang = ["pl"]
# context_and_lang = ["ru","fr","pt-br","es","tr","it","bg","fi","ar","uk","id"]
...
dont_translate = ['1win', 'Bitcoin', 'Tether', 'Ethereum', 'MasterCard', 'Visa', 'Yu Money',
                  'Google Pay', '1WINJET500', 'iPhone']

#  Використовуй ключові слова з язиковими версіями GEO
keys_in_geo = {
    'ru':   {'Lucky Jet':['Lucky Jet','Лаки Джет']},
    'uk':   {'Lucky Jet':['Lucky Jet','Лакі Джет']},
    'pt-br':   {'Lucky Jet':['Lucky Jet','Juego Lucky Jet']},
    'pl':   {'Lucky Jet':['Lucky Jet','1win Lucky Jet','Szczęśliwy Odrzutowiec']},
    'fr':   {'Lucky Jet':['Lucky Jet','Lucky Jet Predictor']}
}
    ...
    with open(csv_url_file, 'w', newline='', encoding='utf-8') as file:
        ...
        for lang in context_and_lang:
            ...
            for row in rows_database:
                ...
                random_time = random.choice([8000, 7000, 9000, 5000, 9000, 15300, 29850, 33370, 46370, 55700, 38200, 68320])
            ...
            settings_keys = ['apk_download_name', 'footer_allrights', 'cookies', 'author_url_sots_set', 'casino_message_new_player',
            ...
            apk_download_name =         settings['apk_download_name']
            ...
            site_url = "https://{http_host}/" + f"{lang}/"

            # CONTEXT настройка
            keys_context_setting = {'about_us':             struktura_id_map[about_us],
                                    'apk_download_name':    apk_download_name,
                                    'apk_page':             struktura_id_map[apk_page],
                                    ...
                                    'catalog_app':          struktura_id_map[catalog_app],
