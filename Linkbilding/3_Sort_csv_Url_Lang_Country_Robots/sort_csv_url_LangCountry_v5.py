...
from proverka_robors_txt.proverka_robots_txt_v3 import is_url_indexed
...
async def main():
    ...
    """
    input_filename = r"Linkbilding\3_Sort_csv_Url_Lang_Country_Robots\input\extracted_urls6.csv"
    output_filename = r"Linkbilding\3_Sort_csv_Url_Lang_Country_Robots\output\result_urls6-5.csv"
