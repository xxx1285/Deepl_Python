    ...
    with open(input_filename, 'r', encoding='utf-8') as infile, open(output_filename, 'w', encoding='utf-8') as outfile:
        for line in infile:
            ...
            if url:  # Переконуємося, що рядок не є пустим
                ...
                modified_url = url.replace("gatesof1win.store/tr", "lucky-jet.world")
...
if __name__ == "__main__":
    input_filename = r'Rediki\4-s_uls_create_A_Link_Zamena301Ankora\input\clean_good_rediki.txt'
    output_filename = r'Rediki\4-s_uls_create_A_Link_Zamena301Ankora\output\redici-URL-lucky-jet_world.txt'
