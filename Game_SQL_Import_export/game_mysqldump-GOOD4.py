...
# 'modx_categories, modx_context, modx_context_setting, modx_media_sources_elements, modx_migx_configs, modx_migx_formtabs, modx_migx_formtab_fields, modx_site_content, modx_site_htmlsnippets, modx_site_templates, modx_site_tmplvars, modx_site_tmplvar_contentvalues, modx_site_tmplvar_templates, modx_system_settings'

"""
    	для переноса сайта - надо удалить старые таблицы  и вставить новые SQL нужные таблицы
    1) modx_categories - Категории
    2) modx_context - контексти
    3) modx_context_setting - настройки контекстов
    4) modx_media_sources_elements - для контекстов
    5) modx_site_content - ресурсы сайта
    6) modx_site_htmlsnippets - Чанки
    7) modx_site_templates - шаблони
    8) modx_site_tmplvars - ТВ
    9) modx_site_tmplvar_contentvalues ------- VNIMANIE - BABEL and TV Zapis svyazki
    10) modx_site_tmplvar_templates

    11) modx_system_settings - настройки сайта

	-----------------
	12) modx_migx_config
	13) modx_migx_formtabs
	14) modx_migx_formtabs_field
"""
