"""
    Данный код представляет собой асинхронный скрипт на языке Python, задачей которого является обработка списка URL-адресов, 
    содержащихся в входном файле. Приложение ищет определенный фрагмент текста ("treatallergicdisorder") в атрибуте href всех тегов <a>
      на каждой веб-странице, указанной в файле, и сохраняет URL-адреса, удовлетворяющие этому условию, в выходной файл.
"""
