...
# написати код на Python, знайти та дістати з text дані "href" з тега "a", знаходимо збіг з словника struktura_id_alias_map і отримуємо ключ за яким знаходимо value в  struktura_id_map, отримане значення використовуємо як ключ в struktura_id_alias_map та отримане значення замінюємо  з text дані "href" з тега "a"
# struktura_id_map = {1: 200, 2: 201}
# struktura_id_alias_map = {1: 'https://gatesofolympus.club/aviator-game/', 200: 'https://gatesofolympus.club/ru/aviator-game/', 2: 'https://gatesofolympus.club/404/', 201: 'https://gatesofolympus.club/ru/404/'}
# text = "<p>Чтобы <a href="https://the-dog-house.org/404/">играть на деньги The Dog House</a> в Pinup Casino, необходимо зарегистрироваться, либо играть </p>"
