websites = {
    ...
    #     {"a10": """a10 = driver.find_element(By.XPATH, '//*[@id="submit"]').click()"""},
    #     ],
    # "https://noshingwiththenolands.com/old-fashioned-rhubarb-pudding-cake/": [
    #     {"a1": """a1 = driver.find_element(By.XPATH, '//*[@id="comment"]').click()"""},
    #     {"a2": """a2 = driver.find_element(By.XPATH, '//*[@id="comment"]').send_keys(my_new_comment)"""},
    #     {"a3": """a3 = driver.find_element(By.XPATH, '//*[@id="author"]').click()"""},
    #     {"a4": """a4 = driver.find_element(By.XPATH, '//*[@id="author"]').send_keys(my_author)"""},
    #     {"a5": """a5 = driver.find_element(By.XPATH, '//*[@id="email"]').click()"""},
    #     {"a6": """a6 = driver.find_element(By.XPATH, '//*[@id="email"]').send_keys(my_email)"""},
    #     {"a7": """a7 = driver.find_element(By.XPATH, '//*[@id="submit"]').click()"""},
    #     ],
                            # "https://www.city.fi/opas/tomi+bjorck+haluaa+tuoda+japanin+helsinkiin+tallainen+on+huippuelamyksiin+panostava+sanchome/13176": [
                            #     {"a2": """a2 = driver.find_element(By.XPATH, '//*[@id="comment_comment"]').send_keys(my_new_comment)"""},
                            #     {"a5": """a5 = driver.find_element(By.XPATH, '//*[@id="comment_nickname"]').send_keys(my_author)"""},
                            #     {"a6": """a6 = driver.find_element(By.XPATH, '//*[@id="form_comment"]').click()"""},
                            #     {"a7": """a7 = driver.find_element(By.XPATH, '//*[@id="comment_url"]').send_keys(my_site_backlink)"""},
                            #     {"captcha_xpath": """captcha_xpath = '//*[@id="comment_c_a_container"]'"""},
                            #     {"captcha_mathematic_result": """captcha_mathematic_result = fun_my_captcha_calculate_mathematic(driver, captcha_xpath)"""},
                            #     {"captcha_mathematic_result_input": """driver.find_element(By.XPATH, '//*[@id="comment_c_a"]').send_keys(captcha_mathematic_result)"""},
                            #     {"a12": """a12 = driver.find_element(By.XPATH, '//*[@id="comment_save"]').click()"""},
                            #     ],
